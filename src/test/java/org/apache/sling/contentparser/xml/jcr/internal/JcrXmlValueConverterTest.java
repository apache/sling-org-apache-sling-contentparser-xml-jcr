...
public class JcrXmlValueConverterTest {
    ...
    public void testStringArray() {
        assertArrayEquals(
                new Object[] {"myString1", "myString2"}, (Object[]) parseValue(NAME, "[myString1,myString2]"));
        assertArrayEquals(
                new Object[] {
    ...
    public void testDoubleArray() {
        assertArrayEquals(new Object[] {new BigDecimal("1.234"), new BigDecimal("2.345")}, (Object[])
    ...
    public void testStringArrayRepPrivileges() {
        assertArrayEquals(new Object[] {"rep:write", "crx:replicate", "jcr:read"}, (Object[])
